...
\begin{figure}[H]
    ...
    \caption{Hierarchie des Nachrichtenaustausch-Szenarios im Unity Editor.}
...
\caption{Raycast debug Visualisierung Beispiel}
...
Der \textit{EventManager} ist ein entscheidendes GameObject, das als zentrales Kommunikationselement fungiert und die
