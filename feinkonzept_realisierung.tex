...
In diesem Beispiel ist ein Rucksack mit \textit{capacity: 120} und folgenden Gegenständen gegeben:
\[
    \begin{align*}
        1 & : \text{"Laptop", 50, 100} \\
        2 & : \text{"Router", 25, 50} \\
        ...
        4 & : \text{"Block", 10, 15} \\
        5 & : \text{"Stifte", 10, 5} \\
        6 & : \text{"Kopfhörer", 25, 50} \\
        7 & : \text{"Taschenrechner", 10, 10} \\
        8 & : \text{"Redbull", 5, 50} \\
        9 & : \text{"USB-Stick", 5, 15} \\
        10 & : \text{"Verteiler", 20, 15} \\
        11 & : \text{"Handy", 30, 100} \\
    \end{align*}
\]
\\
\\
Die Matrizen werden entsprechend aktualisiert, und nach dem Backtracking ergibt sich die Auswahl der Gegenstände für den
maximalen Gesamtwert:
\[
    \text{Aktualisierte }\textbf{dp}\text{-Matrix:}
    \begin{bmatrix}
        0 & 0 & \cdots & 0 & 30 & \cdots & 280 \\
...
\]
\\
Nach ausführung des Knapsack Algorithmus ergibt sich ein maximaler Wert von \textit{280}.\\
\\
Die Items die in der perfekte Lösung ausgewählt wurde sind die folgenden:
\begin{itemize}
    \item Gegenstand 1: Laptop - Wert: 100, Gewicht: 50
    \item Gegenstand 2: Router - Wert: 50, Gewicht: 25
    \item Gegenstand 3: Maus - Wert: 30, Gewicht: 20
    \item Gegenstand 4: Block - Wert: 15, Gewicht: 10
    \item Gegenstand 5: Stifte - Wert: 5, Gewicht: 10
    \item Gegenstand 6: Kopfhörer - Wert: 50, Gewicht: 25
    \item Gegenstand 10: Verteiler - Wert: 15, Gewicht: 20
\end{itemize}
