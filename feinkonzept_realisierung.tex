...
zu gewährleisten. \footnote{Microsoft-Dokumentation, \cite{Universal Unencrypted Protocol}}
...
Wie bereits im Abschnitt \ref{sec:Scene2} erwähnt, benötigen andere Klassen in der Anwendung Zugriff auf die aktuell erkannten QR-Codes in der Szene, um entsprechend reagieren zu können. Dies ist beispielsweise für die Abfrage erforderlich, ob und welche QR-Codes sich im Inventar befinden. Die Bereitstellung dieser Option war eine Herausforderung.
