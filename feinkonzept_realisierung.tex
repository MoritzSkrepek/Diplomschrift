...
der letzte Durchlauf war, wird der Vorgang wiederholt.
...
Dieser Code definiert eine Funktion \textit{EditTextOfInformationObject}, die ein TextMeshPro-Objekt (also ein Objekt welches Text anzeigen kann) aus einem bestimmten
untergeordnetes Objekt des übergeordneten \textit{InfoObject} objekt. Die Methode \textit{GetTextMeshProFromChild} sucht nach
einem spezifischen untergeortneten objekt namens \textit{InformationTextS} welches den Text besitzt welcher angezeigt werden
soll. Dieses versucht dann, das TextMeshPro-Objekt aus diesem Kindspielobjekt zu erhalten. Dadurch ermöglicht es den Zugriff
