...
Dieser Abschnitt beschreibt das\textit{Inventory Controller} Unity Game Objekt und seine angehängte Skript-Komponente im
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5]{images/itemRemoved}
