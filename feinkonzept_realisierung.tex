...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.5, angle=0]{images/qrprefab}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=0.3, angle=0]{images/scanned}
