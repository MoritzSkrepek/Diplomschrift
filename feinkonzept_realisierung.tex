...
\section{Nachrichtenaustausch Anwendungsscenario}\label{sec:Scene1}\marginpar{\small\(\rightarrow\) {\tiny SCHODITSCH}}
...
\begin{figure}[H]
    \centering
    \includegraphics[scale=1]{images/AufbauAnzeige.png}
    \caption{Aufbau in der realen Welt.}
    \label{fig:AufbauUmgebung}
\end{figure}
...
\begin{itemize}
    ...
    \item \textbf{PhotoCaptureObject.StopPhotoModeAsync():} Beendet die Instanz des Photocapture und ruft danach die Funktion innerhalb der Klammer auf.\footnote{Unity, \cite{Photocapture}}
\end{itemize}
...
\begin{figure}[H]
    \centering
    \includegraphics[scalimages/NachrichtenAnzeige.png}
    \caption{Nachricht welche den benutzer angezeigt wir.}
    \label{fig:AufbauUmgebung}
\end{figure}
