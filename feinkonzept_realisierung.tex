...
er Code prüft zuerst, ob das Objekt beweget werden soll. Dann wird überprüft, ob das Objekt bereits am Ende angelangt ist, indem der \textit{moveToCounter} mit der Anzahl der Positionen in \textit{cablePositions} verglichen wird.
...
\begin{itemize}
    \item \textbf{QR Code Manager}: Referenz auf das \textit{QRCodesManager} Game Objekt aus der Szene.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.66\textwidth]{images/itemAdded}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.66\textwidth]{images/itemEntfernt}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.66\textwidth]{images/itemToHeavy}
