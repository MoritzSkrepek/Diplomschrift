...
\subsubsection{Menü version 2}
Die Lösung für das vorherige Problem der fehlenden Übersicht soll das neue Menü sein. Man hat sich dabei an den derzeit
populären und trendigen AR/VR-Spielen orientiert und geschaut, warum die Benutzer Erfahrung deutlich besser ist als die,
die wir in der Version 1 erfahren haben. Das Design wurde komplett abgeändert und vom Nahmenü ist nichtsmehr vorhanden,
stattdessen haben wir jetzt im Hauptmenü, also das Level in das man lädt, vormodellierte von Blender importierte Objekte,
mit denen der Nutzer interagieren kann. Dabei handelt es sich wie in der Abbildung ersichtlich, um zwei Tafeln die von
unserem Diplomarbeitslogo getrennt sind. Die Tafeln ausgestattet mit einem Text und einem dazugehörigen Level-Titel,
darunter ist der Startbutton in Blender vormodelliert. In Unity wurde dann ein Unsichtbarer aber klickbarer Button mit
genau den selben Maßen an die Stelle eingefügt.
