...
\section{Nachrichtenaustausch Anwendungsszenario} \marginpar{\small(\rightarrow) Schoditsch}
...
\subsection{Frontend der Webseite}\marginpar{\small\(\rightarrow\) {\tiny LAMPEL}}
...
\subsection{Backend der Webseite}\marginpar{\small\(\rightarrow\) {\tiny HAYLAZ}}
...
\subsection{Nutzung von QR-Codes} \marginpar{\small\(\rightarrow\) {\tiny HAYLAZ}}
