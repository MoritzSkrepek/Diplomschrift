...
\subsection{Abläufe}
%TODO: HIER DIAGRAMME VON HAUPTMENU, NACHRICHTENAUSTAUSCH UND KNAPSACK EINFÜGEN
...
beschleunigt.\footnote{Unreal Engine Dokumentation, \cite{Blueprint Visual Scripting}} %https://docs.unrealengine.com/5.3/en-US/blueprints-visual-scripting-in-unreal-engine/
...
\subsection{Wahl des Modellierungsprogramm}\marginpar{\small\(\rightarrow\) {\tiny LAMPEL}}
